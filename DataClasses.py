...
# Songli Zhu, 2022-Mar-24, Add codes to Constructor, Properties, and Methods in Track class
#------------------------------------------#
...
class CD:
    ...
    def add_track(self, track: Track) -> None:
        ...
        Raises:
            Exception: If track type is not Track.
