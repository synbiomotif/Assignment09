...
# Songli Zhu, 2022-Mar-24, Added codes to handle list of files in save_inventory and load_inventory methods.
#------------------------------------------#
        ...
        try:
            ...
            with open(file_name_Track, 'w') as file:
                for disc in lst_Inventory:
                    ...
                    for track in tracks:
                        record = '{},{}'.format(cd_id, track.get_record())
                        file.write(record)
    ...
    def get_track_info():
        ...
        while flag:
            ...
            try:
                ...
                print('Track position must be an Integer!') 
